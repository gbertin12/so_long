...
/*   Updated: 2022/05/30 15:53:04 by gbertin          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_move_left(t_map *map)
{
	...
	{
		if (!(map->map[map->player.row][map->player.col - 1] == 'E' && map->items != 0))
		{
			...
			map->nb_move++;
			ft_putstr_fd(ft_itoa(map->nb_move), 1);
			ft_putstr_fd("\n", 1);
		}
	}
	ft_init_player(map);
...
void	ft_move_up(t_map *map)
{
	...
	{
		if (!(map->map[map->player.row - 1][map->player.col] == 'E' && map->items != 0))
		{
